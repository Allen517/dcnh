...
def get_model_perf(base_log_path, base_res_path, base_model_path, base_label_path, log_rcd_file, out_file, range_from, range_to, gap):
    skip_step = 100
    cand_size = 9
    methods = ('dcnh-sp', 'dcnh-dp', 'pale-mlp')
        ...
        for method in methods:
            ...
            for k in np.arange(range_from, range_to, gap):
                ...
                for i in np.arange(.2, 1, .1):
                    filename='{}/{}.s2t.train_{}.s_{}.c_0.8.times_{}.log'.format(base_log_path, method, j, i, k)
                    ...
                    if test_loss:
                        ...
                        if method=='dcnh-sp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.{}.times_{}.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
                        if method=='dcnh-dp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.{}.times_{}.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
                        if method=='pale-mlp':
                            eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.times_{}.{}.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)

                    filename='{}/{}.s2t_anchor_reg.train_{}.s_{}.c_0.8.times_{}.log'.format(base_log_path, method, j, i, k)
                    test_loss = get_test_loss(filename)
                    if test_loss:
                        test_loss = map(float, test_loss[::skip_step])
                        max_idx = np.argmax(test_loss)
                        fout.write('{}: max test loss:{} @{}\n'.format(filename, max(test_loss), np.argmax(test_loss)))
                        if method=='dcnh-sp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
                        if method=='dcnh-dp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
                        if method=='pale-mlp':
                            eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)

                for i in np.arange(.1, 1, .1):
                    if i==0.8:
                        continue
                    filename='{}/{}.s2t.train_{}.s_0.5.c_{}.times_{}.log'.format(base_log_path, method, j, i, k)
                    test_loss = get_test_loss(filename)
                    if test_loss:
                        test_loss = map(float, test_loss[::skip_step])
                        max_idx = np.argmax(test_loss)
                        fout.write('{}: max test loss:{} @{}\n'.format(filename, max(test_loss), np.argmax(test_loss)))
                        if method=='dcnh-sp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.{}.times_{}.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
                        if method=='dcnh-dp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.{}.times_{}.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
                        if method=='pale-mlp':
                            eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line.target.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.alp_model.{}.times_{}.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)

                    filename='{}/{}.s2t_anchor_reg.train_{}.s_0.5.c_{}.times_{}.log'.format(base_log_path, method, j, i, k)
                    test_loss = get_test_loss(filename)
                    if test_loss:
                        test_loss = map(float, test_loss[::skip_step])
                        max_idx = np.argmax(test_loss)
                        fout.write('{}: max test loss:{} @{}\n'.format(filename, max(test_loss), np.argmax(test_loss)))
                        if method=='dcnh-sp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
                        if method=='dcnh-dp':
                            eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
                        if method=='pale-mlp':
                            eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.times_{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, k, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)
...
get_model_perf('log', 'res', 'anchor_res', 'src/data_proc/toy_dat/labels/blogcatalog_labels', 'log_analy.toy', 'mrr.toy', 1, 5, 1)
