		...
		for method in methods:	
			for j in np.arange(range_from, range_to, gap):
				...
				for i in np.arange(.2, 1, .1):
					filename='{}/{}.s2t_anchor_reg.train_{}.s_{}.c_0.8.log'.format(base_log_path, method, j, i)
					...
					if test_loss:
						...
						if method=='dcnh-sp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
						if method=='dcnh-dp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
						if method=='dcn-sp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _dot_distance)
						if method=='pale-mlp':
							eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)
						if method=='pale-lin':
							eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_{}.c_0.8.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_{}.c_0.8.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_lin_res, _geo_distance)	

				for i in np.arange(.1, 1, .1):
					filename='{}/{}.s2t_anchor_reg.train_{}.s_0.5.c_{}.log'.format(base_log_path, method, j, i)
					test_loss = get_test_loss(filename)
					if test_loss:
						test_loss = map(float, test_loss[::skip_step])
						max_idx = np.argmax(test_loss)
						fout.write('{}: max test loss:{} @{}\n'.format(filename, max(test_loss), np.argmax(test_loss)))
						if method=='dcnh-sp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
						if method=='dcnh-dp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_dp_res, _hamming_distance)
						if method=='dcn-sp':
							eval_hashing_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_sp_res, _dot_distance)
						if method=='pale-mlp':
							eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_mlp_res, _geo_distance)
						if method=='pale-lin':
							eval_pale_model(src_lbs, target_lbs, '{}/blog.line.src.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, i, 10), '{}/blog.line_anchor_reg.target.train_{}.s_0.5.c_{}.epoch{}.node_embeddings_order2'.format(base_res_path, j, i, 10), '{}/blog.alp_model.{}.line_anchor_reg.train_{}.s_0.5.c_{}.epoch_{}'.format(base_model_path, method, j, i, max_idx*skip_step), cand_size, out_file, calc_lin_res, _geo_distance)
