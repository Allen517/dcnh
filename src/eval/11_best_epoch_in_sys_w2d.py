        ...
        for method in methods:
            ...
            for k in np.arange(range_from, range_to, gap):
                ...
                if test_loss:
                    ...
                    if method=='dcnh-sp':
                        eval_hashing_model(src_lbs, target_lbs, '{}/weibo_all.txt'.format(base_res_path), '{}/douban_all.txt'.format(base_res_path), '{}/w2d.sys.alp_model.{}.train_{}.times_{}.epoch_{}'.format(base_model_path, method, j, k, max_iter), cand_size, out_file, calc_mlp_sp_res, _hamming_distance)
...
get_model_perf('log', 'd2w_embedding/16/', 'anchor_res', 'data/douban2weibo/w2d.anchor_links.labels', 'log_analy.w2d', 'mrr.w2d', 1, 6, 1)
